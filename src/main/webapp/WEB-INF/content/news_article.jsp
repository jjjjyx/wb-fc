...
<div id="app">
    ...
    <section class="am-g am-g-fixed blog-fixed blog-content" style="background: #fff;padding-left: 100px;padding-right: 100px;">
        <div class="am-u-sm-12">
            ...
            <fc-comment :comment-id="'${new_date.comment_id}'" cur="${user.uid}" style="margin-bottom: 30px;"></fc-comment>
        ...
        <div class="am-u-md-4 am-u-sm-12 blog-sidebar">
            ...
            <%--</div>--%>
            <%--&lt;%&ndash;<div class="blog-sidebar-widget blog-bor">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<h2 class="blog-text-center blog-title"><span>Contact ME</span></h2>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<p>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<a href=""><span class="am-icon-qq am-icon-fw am-primary blog-icon"></span></a>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<a href=""><span class="am-icon-github am-icon-fw blog-icon"></span></a>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<a href=""><span class="am-icon-weibo am-icon-fw blog-icon"></span></a>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<a href=""><span class="am-icon-reddit am-icon-fw blog-icon"></span></a>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<a href=""><span class="am-icon-weixin am-icon-fw blog-icon"></span></a>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</p>&ndash;%&gt;--%>
            <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
