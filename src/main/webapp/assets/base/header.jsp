...
<link rel="stylesheet" href="${path}/assets/css/element-ui.min.css">
<link href="${path}/assets/css/${cssPath == null?'index':cssPath}.css" rel="stylesheet">
<link href="${path}/assets/css/animate.min.css" rel="stylesheet">
<link href="${path}/assets/css/app.css" rel="stylesheet">
<c:if test="${loading}">
    <link href="${path}/assets/css/preloader.min.css" rel="stylesheet">
</c:if>
